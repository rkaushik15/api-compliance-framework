...
ENDPOINTS = ["sequence", "service_info", "metadata"]
...
def main():	
    server = ReportServer("report")
    server.render_html()
    server.set_free_port()
    server.serve_thread(3600)
